...
def set_values(prob, num_nodes, design_range, spec_energy):
    ...
    # bypass the heat pump on certain segments
    prob['analysis.v0v1.bypass_refrig'] = np.ones((num_nodes,))
    prob['analysis.v1v0.bypass_refrig'] = np.ones((num_nodes,))
    prob['analysis.engineoutclimb.bypass_refrig'] = np.ones((1,))
