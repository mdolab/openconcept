...
class VectorConcatenateComp(ExplicitComponent):
    ...
    def add_output(self):
        ...
        """
        raise NotImplementedError("Use add_relation method, not add_output methodto create an concatenate relation")
...
class VectorSplitComp(ExplicitComponent):
    ...
    def add_output(self):
        ...
        """
        raise NotImplementedError("Use add_relation method, not add_output methodto create a split relation")
