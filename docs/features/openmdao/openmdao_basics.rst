...
-----------------------
The ``examples/TBM850.py`` `script <https://github.com/mdolab/openconcept/blob/main/openconcept/examples/TBM850.py>`_ models a single-engine turboprop aircraft and uses all of the elements mentioned on this page in an OpenConcept context.
